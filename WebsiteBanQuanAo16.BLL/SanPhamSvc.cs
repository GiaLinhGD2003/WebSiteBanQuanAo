...
namespace WebsiteBanQuanAo16.BLL
{
    public class SanPhamSvc : GenericSvc<SanPhamRep, SanPham>
    {
        ...
        #region  -- Methods --
        public object timSanPham(TimSanPhamReq s)
        {
            var res = new SingleRsp();
            try
            {
        ...
        public SingleRsp themSanPham(SanPhamReq sanphamReq)
        {
            var res = new SingleRsp();
        ...
        public SingleRsp suaSanPham(SanPhamReq sanphamReq, string id)
        {
            int result;
        ...
        public SingleRsp xoaSanpham(int id)
        {
            var res = new SingleRsp();
            var context = new QLQuanAoContext();
            try
